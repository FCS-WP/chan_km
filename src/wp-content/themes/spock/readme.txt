...
Please install and activate it before starting to use the theme Spock.
...
Theme documentation is available on https://spock.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Spock is Fontello.
