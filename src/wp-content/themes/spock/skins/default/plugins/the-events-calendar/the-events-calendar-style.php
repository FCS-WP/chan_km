...
if ( ! function_exists( 'spock_tribe_events_get_css' ) ) {
	add_filter( 'spock_filter_get_css', 'spock_tribe_events_get_css', 10, 2 );
	function spock_tribe_events_get_css( $css, $args ) {
