...
if ( ! function_exists( 'spock_woocommerce_get_css' ) ) {
	add_filter( 'spock_filter_get_css', 'spock_woocommerce_get_css', 10, 2 );
	function spock_woocommerce_get_css( $css, $args ) {
...
$fdir = spock_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
