		...
		$schemes = array(
			...
			'default' => array(
				...
				'colors'   => array(
					...
					'text'             => '#6D7072', //ok
					'text_light'       => '#94959A', //ok
					'text_dark'        => '#1E2226', //ok
					'text_link'        => '#BBAD60', //ok
					'text_hover'       => '#A59642', //ok
					'text_link2'       => '#597293', //ok
					'text_hover2'      => '#435C7C', //ok
					'text_link3'       => '#657162', //ok
					'text_hover3'      => '#485844', //ok

					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#FFFFFF', //ok
					'alter_bg_hover'   => '#F3F0EB', //ok
					'alter_bd_color'   => '#E6D8CF', //ok
					'alter_bd_hover'   => '#D2BEB1', //ok
					'alter_text'       => '#6D7072', //ok
					'alter_light'      => '#94959A', //ok
					'alter_dark'       => '#1E2226', //ok
					'alter_link'       => '#BBAD60', //ok
					'alter_hover'      => '#A59642', //ok
					'alter_link2'      => '#597293', //ok
					'alter_hover2'     => '#435C7C', //ok
					'alter_link3'      => '#657162', //ok
					'alter_hover3'     => '#485844', //ok

					// Extra blocks (submenu, tabs, color blocks, etc.)
					'extra_bg_color'   => '#1E2226', //ok
					'extra_bg_hover'   => '#3f3d47',
					'extra_bd_color'   => '#313131',
					'extra_bd_hover'   => '#575757',
					'extra_text'       => '#959697', //ok
					'extra_light'      => '#afafaf',
					'extra_dark'       => '#FFFFFF', //ok
					'extra_link'       => '#BBAD60', //ok
					...
					'input_bd_color'   => '#E6D8CF', //ok
					'input_bd_hover'   => '#D2BEB1', //ok
					'input_text'       => '#6D7072', //ok
					'input_light'      => '#94959A', //ok
					'input_dark'       => '#1E2226', //ok
			...
			'dark'    => array(
				...
				'colors'   => array(
					...
					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#14171A', //ok
					'alter_bg_hover'   => '#2B2E31', //ok
					'alter_bd_color'   => '#323538', //ok
					'alter_bd_hover'   => '#494B4D', //ok
					'alter_text'       => '#C4C4C4', //ok
					'alter_light'      => '#959697', //ok
					'alter_dark'       => '#F1F3EB', //ok
					'alter_link'       => '#BBAD60', //ok
					'alter_hover'      => '#A59642', //ok
					'alter_link2'      => '#597293', //ok
					'alter_hover2'     => '#435C7C', //ok
					...
					'input_bg_color'   => '#transparent', //ok
					'input_bg_hover'   => '#transparent', //ok
					'input_bd_color'   => '#323538', //ok
					'input_bd_hover'   => '#494B4D', //ok
					'input_text'       => '#C4C4C4', //ok
					'input_light'      => '#959697', //ok
					'input_dark'       => '#FFFFFF', //ok

					// Inverse blocks (text and links on the 'text_link' background)
					'inverse_bd_color' => '#e36650',
					'inverse_bd_hover' => '#cb5b47',
					'inverse_text'     => '#F1F3EB', //ok
					'inverse_light'    => '#6f6f6f',
					'inverse_dark'     => '#1E2226', //ok
					'inverse_link'     => '#FFFFFF', //ok
					'inverse_hover'    => '#1E2226', //ok
